...
function AdminLoginContent() {
  ...
  useEffect(() => {
    ...
    if (error && message) {
      ...
      toast.error("Bu Google hesabına bağlı restoran hesabı bulunamadı. Önce restoran kaydı oluşturun.");
    } else if (error === "not_approved") {
      toast.error("Hesabınız henüz onaylanmamış.");
    } else if (error === "google_not_configured") {
      toast.error("Google girişi şu an yapılandırılmamış.");
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-4 md:p-8 lg:p-12">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 h-12 w-full border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all group font-semibold text-gray-700"
          >
